...
const FR: Record<string, string> = {
  ...
  "zones.eyebrow": "Les espaces", "zones.title": "un ruban,<br>six mondes", "zones.hint": "cliquez un espace pour entrer", "zones.scroll": "défilez pour parcourir le ruban →",
  ...
  "stats.eyebrow": "Les chiffres, à l'échelle", "stats.p": "Chaque bloc ci-dessous est dessiné proportionnellement à la surface qu'il représente. Survolez pour voir l'espace ; le rectangle entier représente les 29 000 m² de surface locative brute.",
